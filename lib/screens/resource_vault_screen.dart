        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              Text('Newest Additions',style: GoogleFonts.rubik(fontWeight: FontWeight.w700,fontSize: 18),),
              const SizedBox(height: 5),
              Row(
                children: [
               Text('Latest additions to ',style: GoogleFonts.rubik(fontWeight: FontWeight.w400,fontSize: 12),),
                RichText(
                  text: TextSpan(
                      children: [
                        TextSpan(
                 ...
                 Text(' treasury!',style: GoogleFonts.rubik(fontWeight: FontWeight.w400,fontSize: 12),),
              ],),
              const SizedBox(height: 5),
                  ...
                  children: [
                    ResourceCard(
                     first: 'VIDEO RESOURCE',
                      ...
                      description: 'Memorizing the hardest facial\n bones using this mnemonic.', image: 'assets/classification.png', onTap: () {  },
                    ),
                    ResourceCard(
                      first: 'TOPICAL GUIDANCE',
                      title: 'Biological\nMolecules',
                      description: 'Highly-rated topical\nBiology.', image: 'assets/bio.png', onTap: () {  },
                    ),
                  ],
                ),
              ),
              ...
              Text(
                ...
                style: GoogleFonts.rubik(fontSize: 10,fontWeight: FontWeight.w400),
              ),
              const SizedBox(height: 10),
              SingleChildScrollView(
               scrollDirection: Axis.horizontal,
               child: Row(
                 children: [
                   CategoryCard(
                     ...
                     first: 'DOWNLOADABLE RESOURCE', onPressed: () {},
                   ),
                   CategoryCard(
                     title: 'MDCAT ‘23\nSyllabus',
              ...
              const SizedBox(height: 8,),
              Text('Toppers’ Insights to every topic from every board of Pakistan! ',style: GoogleFonts.rubik(fontWeight: FontWeight.w400,fontSize: 10),),
              const SizedBox(height: 8,),
               SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
                  children: [
                    ...
                    ResourceCard(
                      ...
                      image: 'assets/s & p.png', onTap: () {  },
                    ),
                    ResourceCard(
                      first: '',
                      title: 'DAWN OF MODERN\nPHYSICS',
                      description: 'PHYSICS - KPK BOARD',
                      image: 'assets/dawn.png', onTap: () {  },
                    ),
                  ],
                ),
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Study Notes', style: GoogleFonts.rubik(
                      color: Colors.black,
                      fontWeight: FontWeight.w700,
                      fontSize: 17
                  ),),
              ...
              Text('The most comprehensive notes in town.',style: GoogleFonts.rubik(fontWeight: FontWeight.w400,fontSize: 10),),
               SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
                  children: [
              ...
              const SizedBox(height: 8,),
              Text('One Chapter. One Page. Half-Hour Revisions!',style: GoogleFonts.rubik(fontWeight: FontWeight.w400,fontSize: 10),),
              const SizedBox(height: 8,),
               SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
              ...
              const SizedBox(height: 8,),
              Text('All the mnemonics you need. No more mindless repetition! ',style: GoogleFonts.rubik(fontWeight: FontWeight.w400,fontSize: 10),),
              const SizedBox(height: 8,),
               SingleChildScrollView(
                scrollDirection: Axis.horizontal,
                child: Row(
                  children: [
                    ResourceCard(
                      title: 'RNA and DNA\nViruses',
                      description: 'Learn all the RNA and DNA\nViruses with just a simple\ntrick!',
                    ...
                    ResourceCard(
                      first: '',
                      title: 'Pro-Glucose\nHormones',
                      description: 'Learn all the classes of\nenzymes with just\na simple word!',
                      image: 'assets/hormones.png', onTap: () {  },
                    ),
                  ],
                ),
              ),
